    ...
    return (
        <div className="ImageCreditGrid">
            ...
            <div className="cred-flex">
                {props.themeImages.map((curr_img, index) => ( <a href={curr_img.img_src} rel="noopener noreferrer" target="_blank" key={index+30}><img src={curr_img.img} alt="background" width="150" height="150"></img></a>))}
            </div>
        </div>
    )
}
