    ...
    render() {
      return ( 
        ...
        <header className="App">       
          ...
          {this.state.theme === 403 ?  <Popup trigger={true} content={<div data-testid="popup-content"><h2>Oh no!</h2><p>In order to use Spotify Moodboard you have to send me your email associated with your Spotify so that I can add you since I'm still in development mode. </p></div>} /> : null}
          {this.state.theme && (this.state.theme !== 404 && this.state.theme !== 403) && !this.state.theme.font ? <Popup trigger={true} content={<div data-testid="popup-content"><h2>Oh no!</h2><p>you do not have enough spotify content to create a moodboard. Keep jamming out and check back at a later time!</p></div>} /> : null}
          {this.state.theme === 404 ? <Popup trigger={true} content={<div data-testid="popup-content"><h2>Oh no!</h2><p className="margin-space">there seems to be an error with the server:( <br></br>
